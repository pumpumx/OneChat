...
chatRouter.route('/save-personal-message').post(verifyJWT , savePersonalChatMessage)
chatRouter.route('/fetch-personal-message').get(verifyJWT , fetchPersonalChatMessage)
